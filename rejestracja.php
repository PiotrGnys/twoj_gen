	...
	if(isset($_POST['nazwisko'])){
		...
		if($wszystko_ok==true){
			...
			try{
				...
				$db = new PDO("mysql:dbname=$db_name;host=127.0.0.1;charset=utf8", '$db_user', '$db_password', [PDO::ATTR_EMULATE_PREPARES=>false, PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION]);
			...
			$query = $db->prepare('INSERT INTO pacjenci (NULL, :Imie, :Nazwisko, :PESEL, :Płeć, :Data urodzenia, :Uilca, :Kod pocztowy, :Miejscowość, :Numer badania)');
